...
ATerm2LocalMPCamera::ATerm2LocalMPCamera(const FObjectInitializer& ObjectInitializer)
...
void ATerm2LocalMPCamera::BeginPlay()
{
	Super::BeginPlay();
	ensureMsgf(GetWorld(), TEXT("ATerm2LocalMPCamera::BeginPlay() Missing World!"));
	Term2GameModeBase = Cast<ATerm2GameModeBase>(GetWorld()->GetAuthGameMode());
}

void ATerm2LocalMPCamera::Tick(float DeltaTime)
{
