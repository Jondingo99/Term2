...
#include "Term2GameStateBase.generated.h"
...
UCLASS()
class TERM2_API ATerm2GameStateBase : public AGameStateBase
{
	GENERATED_BODY()
public:
	...
	void OnPlayerReachedEnd(ATerm2CharacterBase* Term2Character);
